...
<div class="error-wrap">
    <div class="error-card">
        <div class="error-icon" style="color: #F7C1C1;">
            <i class="fas fa-exclamation-circle"></i>
        </div>
        <div class="error-number" style="color: #E24B4A;">500</div>
        <div class="error-title">Error interno del servidor</div>
        <p class="error-desc">
            Algo salió mal en el servidor. Estamos trabajando para solucionarlo. Intenta de nuevo en unos minutos.
        </p>
        <a href="{{ route('home') }}" class="error-btn" style="background: #E24B4A;">
